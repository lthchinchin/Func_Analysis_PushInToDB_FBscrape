...
class Some_Widgets(GUI):  # inherits from the GUI class
    def __init__(self, parent, controller):
        ...
        button1.pack()
        button2 = tk.Button(frame2, text="Data Analys", command=fnc.main)
        button2.pack()
        #-------frame3
        ...
        column_list_account = ["Id", "Company","Language","Position","Date created"]
        ...
        def Data_Analys_Save():
            print("Phan tich du lieu!")
